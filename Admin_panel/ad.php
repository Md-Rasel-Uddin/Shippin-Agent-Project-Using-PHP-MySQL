			...
			<form method="post" hidden>				
				<table class="table table-condenced table-hover table-bordered table-responsive">
					...
					<div style="background: #E1E1E1;padding: 7px;">
						<h2 style="background-color: #85CFFE;padding: 7px;">LATEST ADVERTISE</h2>
				<br>
					<?php	
					$host="localhost";
					$user="root";
					...
					<h3 style="background-color: #FCFCFC;padding: 8px;border: 0px solid gray">
					...
					<form method="post" style="margin-top: 20px;">
						...
						<br>
						Comment by:<a href="#"><?php echo $comment_by;?></a> - 
